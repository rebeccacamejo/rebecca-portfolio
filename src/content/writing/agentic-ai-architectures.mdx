...
Two weeks ago, we got handed one of those projects that makes you both excited and slightly terrified:
...
That's why I dove head first into CrewAI, OpenAI SDK, LangGraph, Motia, MCP, etc. — to understand what is really going on from just one LLM call to chaining to routing to a ton of other patterns out there.
